-- Brainrot Free Eats GUI (Executor) - Closest Plot Detect
...
-- Closest plot detection (most reliable)
local function getPlayerPlot()
    ...
    if closestPlot then
        ...
        print("Detected plot:", closestPlot.Name, "| Distance:", math.floor(closestDist))
    end
...
backBtn.MouseButton1Click:Connect(function()
    ...
    cachedPlot = nil -- force re-detect when going back to base
...
print("Brainrot Free Eats loaded - Closest Plot Detect")
